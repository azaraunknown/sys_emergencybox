...
function EmergencySystem.OpenMenu()
    ...
    alert_buttons:Build()
    alert_height = s.current_state_h + alert_buttons.ContentsSize
    ...
    recorded_announcements_height = s.current_state_h + s.components_dock_offset + s.components_inner_offset
